...
class BrightSpotsPass : ScriptableRenderPass
{
    ...
    Material flareMaterial, RenderTexture renderTexture)
  {
    ...
    drawArgsBuffer = new ComputeBuffer(4, sizeof(uint), ComputeBufferType.Raw);
  ...
  public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
  {
    ...
    cmd.DrawProceduralIndirect(Matrix4x4.identity, flareMaterial, -1, MeshTopology.Triangles,
